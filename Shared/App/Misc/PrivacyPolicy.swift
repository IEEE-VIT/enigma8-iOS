    ...
    var body: some View {
        VStack {
            ...
            Image("PrivacyIcon")
                ...
                .scaledToFit()
                .frame(width: 40)
                CustomLabel(text: "Privacy Policy", font: .Cinzel(size: 26, weight: .bold))
            }
            .padding(.top,20)
            ...
            Text(
                """
                 Your privacy is important to us. It is IEEE-VIT's policy to respect
                 your
                 ...
                 thirdparties, except when required to by law.
                 ...
                 free to contact us at contact@ieeevit.org
                 """
            )
